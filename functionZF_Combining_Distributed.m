function [V_RZF_Combining] = functionZF_Combining_Distributed(Hhat,nbrOfRealizations,M,N,K,p)
%%=============================================================
%The file is used to generate RZF combining vectors in the paper:
%
...
V_RZF_Combining = zeros(M*N,K,nbrOfRealizations);
...
for n = 1:nbrOfRealizations
    ...
    for m = 1:M
        ...
        V_RZF_Combining((m-1)*N+1:m*N,:,n) = Hhatallj/(Hhatallj'*Hhatallj + inv(Dp));
...
V_RZF_Combining = permute(V_RZF_Combining,[1 3 2]);