function [R_AP,HMean_Withoutphase,channelGain,channelGain_LoS,channelGain_NLoS] = functionGenerateSetupDeploy(M,K,N,nbrOfSetups,correlatedShadowing,probLoS)
%%=============================================================
